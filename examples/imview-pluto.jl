...
# ╔═╡ e27273cb-f0ab-4702-89dc-675473decce2
using PlutoUI

# ╔═╡ 92e89027-2357-4966-9a8f-806bc8f85cab
using ImageIO
...
# ╔═╡ 816134e9-2b64-4d5f-bad0-3b4c7969b120
fitsurl = "http://www.astro.uvic.ca/~wthompson/astroimages/fits/656nmos.fits"

# ╔═╡ d1e5947b-2c1a-46fc-ab8f-feeba03453e7
img = AstroImages.restrict(
    AstroImage(download(fitsurl))
);
...
md"""
## `implot`
Enable the following cells to use `Plots` instead.
"""
...
manifest_format = "2.0"
project_hash = "ef7da4771d9eedbfc7bb5da94cd4c818f826c4f8"
